...
function updateMotionValuesFromProps(element, next, prev) {
  ...
  for (const key in next) {
    ...
    if (isMotionValue(nextValue)) {
      ...
      if (true) {
        warnOnce(nextValue.version === "10.12.7", `Attempting to mix Framer Motion versions ${nextValue.version} with 10.12.7 may not work as expected.`);
      }
